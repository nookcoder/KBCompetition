...
public class Personal_PickupAdapter extends RecyclerView.Adapter<com.kbc.Pickup.Personal_PickupAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.kbc.Pickup.Personal_PickupAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.personal_pickup_list_item, parent, false);
        return new com.kbc.Pickup.Personal_PickupAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.kbc.Pickup.Personal_PickupAdapter.MyViewHolder holder, int position) {
